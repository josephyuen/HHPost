...
import com.teetaa.wx.lib.util.SSLUtil;
...
//        sClientBuilder.proxy(Proxy.NO_PROXY);
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP){
            sClientBuilder.sslSocketFactory(new SSL(SSLUtil.unSafeTrustManager), SSLUtil.unSafeTrustManager).build();
        }
