...
public class GlideManager {
     ...
     * @param placeholder
     */
    public static void loadImg(Object obj, ImageView iv, Drawable placeholder,RequestOptions options) {
        Glide.with(iv.getContext()).load(obj).apply(options
                .error(placeholder)
    ...
    public static void loadImg(Object obj, ImageView iv, Drawable placeholder) {
        loadImg(obj,iv,placeholder,getRequestOptions());
    }
